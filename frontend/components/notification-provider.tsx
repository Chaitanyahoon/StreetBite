...
// Pages where we don't want to show location/notification prompts
const EXCLUDED_PATHS = ['/reset-password', '/forgot-password', '/signin', '/signup', '/register', '/admin', '/vendor']
...
export function NotificationProvider({ children }: { children: React.ReactNode }) {
    ...
    // Check if current path should exclude prompts
    const shouldHidePrompts = EXCLUDED_PATHS.some(path => pathname?.startsWith(path))
